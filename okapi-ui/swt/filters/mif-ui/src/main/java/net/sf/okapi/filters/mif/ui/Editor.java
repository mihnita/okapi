...
public class Editor implements IParametersEditor {
	...
	private Button chkExtractPgfNumFormatsInline;
	private Button chkExtractReferenceFormats;
		...
		boolean readOnly)
	{
		...
		chkExtractPgfNumFormatsInline = new Button(cmpTmp, SWT.CHECK);
		chkExtractPgfNumFormatsInline.setText(Res.getString("extractPgfNumFormatsInline"));

		chkExtractReferenceFormats = new Button(cmpTmp, SWT.CHECK);
		chkExtractReferenceFormats.setText(Res.getString("extractReferenceFormats"));
	...
	private void setData () {
		...
		chkExtractPgfNumFormatsInline.setSelection(params.getExtractPgfNumFormatsInline());
		chkExtractReferenceFormats.setSelection(params.getExtractReferenceFormats());
	...
	private boolean saveData () {
		...
		params.setExtractPgfNumFormatsInline(chkExtractPgfNumFormatsInline.getSelection());
		params.setExtractReferenceFormats(chkExtractReferenceFormats.getSelection());
