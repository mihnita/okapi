...
// Common part
		...
		if (data instanceof net.sf.okapi.filters.table.base.Parameters) {
			...
			List<String> sourceIdSuffixes = new ArrayList<>();
			List<String> targetColumns = new ArrayList<>();
			List<String> targetLanguages = new ArrayList<>();
			List<String> targetSourceRefs = new ArrayList<>();
			List<String> sourceIdColumns = new ArrayList<>();
			List<String> sourceIdSourceRefs = new ArrayList<>();
			List<String> commentColumns = new ArrayList<>();
			List<String> commentSourceRefs = new ArrayList<>();
		...
		if (data instanceof net.sf.okapi.filters.table.fwc.Parameters) {
			...
			List<String> columnStartPositions = new ArrayList<>();
			List<String> columnEndPositions = new ArrayList<>();
