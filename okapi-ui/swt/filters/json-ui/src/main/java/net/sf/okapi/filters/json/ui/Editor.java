...
public class Editor implements IParametersEditor {
	...
	private Text edNoteRules;
	private Text edIdRules;
	private Text edGenericMetadataRules;
	private Text edExtractionRules;
		...
		boolean readOnly)
	{
		...
		new Label(grpTmp, SWT.NONE).setText(Res.getString("stNoteRules"));
		edNoteRules = new Text(grpTmp, SWT.BORDER);
		edNoteRules.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		
		new Label(grpTmp, SWT.NONE).setText(Res.getString("stGenericMetadataRules"));
		edGenericMetadataRules = new Text(grpTmp, SWT.BORDER);
		edGenericMetadataRules.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		
		new Label(grpTmp, SWT.NONE).setText(Res.getString("stIdRules"));
		edIdRules = new Text(grpTmp, SWT.BORDER);
		edIdRules.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		
		new Label(grpTmp, SWT.NONE).setText(Res.getString("stExtractionRules"));
		edExtractionRules = new Text(grpTmp, SWT.BORDER);
		edExtractionRules.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
	...
	private void setData () {
		...
		edNoteRules.setText(params.getNoteRules()==null ? "" : params.getNoteRules());
		edIdRules.setText(params.getIdRules()==null ? "" : params.getIdRules());
		edExtractionRules.setText(params.getExtractionRules()==null ? "" : params.getExtractionRules());
		edGenericMetadataRules.setText(params.getGenericMetaRules()==null ? "" : params.getGenericMetaRules());
	...
	private boolean saveData () {
		...
		params.setNoteRules(edNoteRules.getText().trim());
		params.setIdRules(edIdRules.getText().trim());
		params.setExtractionRules(edExtractionRules.getText().trim());
		params.setGenericMetaRules(edGenericMetadataRules.getText().trim());
