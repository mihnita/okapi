...
public class RuleDialog {
		...
		int regexOptions)
	{
		...
		edExpression.addModifyListener(e -> updateResults());
		...
		edSample.addModifyListener(e -> updateResults());
		...
		cbRuleType.addModifyListener(e -> updateGroups());
		...
		edSource.addModifyListener(e -> updateResults());
		...
		edTarget.addModifyListener(e -> updateResults());
		...
		edName.addModifyListener(e -> updateResults());
		...
		edNote.addModifyListener(e -> updateResults());
