...
//chkExtractOuterStrings.setEnabled(false); // NOT WORKING YET		
		...
		chkRemoveBSlashEscape = new Button(grpTmp, SWT.CHECK);
		chkRemoveBSlashEscape.setText("Escaped characters are unescaped on import (e.g. \\\" -> \").");
		gdTmp = new GridData(GridData.FILL_HORIZONTAL);
		gdTmp.horizontalSpan = 2;
		chkRemoveBSlashEscape.setLayoutData(gdTmp);
...
//		chkExtractOuterStrings.setSelection(params.getExtractOuterStrings());
		...
		chkRemoveBSlashEscape.setSelection(params.getRemoveBSlashEscape());
...
//		params.setExtractOuterStrings(chkExtractOuterStrings.getSelection());
		...
		params.setRemoveBSlashEscape(chkRemoveBSlashEscape.getSelection());
