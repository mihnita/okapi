...
public class Editor implements IParametersEditor {
		...
		boolean readOnly)
	{
		...
		*/
        ...
        Label stSubFilter = new Label(grpTmp, SWT.NONE);
...
//options go there
	...
	private boolean saveData () {
		...
		params.setSubfilter(edSubfilterId.getText());
	...
	private void updateInlineCodes () {
		boolean useCodeFinder = chkUseCodeFinder.getSelection();
		pnlCodeFinder.setEnabled(useCodeFinder);
	}
}
