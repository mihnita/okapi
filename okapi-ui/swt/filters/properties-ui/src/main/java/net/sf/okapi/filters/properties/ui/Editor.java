...
public class Editor implements IParametersEditor {
		...
		boolean readOnly)
	{
		...
		chkUseJavaEscapes = new Button(cmpTmp, SWT.CHECK);
		chkUseJavaEscapes.setText(Res.getString("chkUseJavaEscapes"));
	...
	private void setData () {
		...
		chkUseJavaEscapes.setSelection(params.isUseJavaEscapes());
	...
	private boolean saveData () {
		...
		params.setUseJavaEscapes(chkUseJavaEscapes.getSelection());
