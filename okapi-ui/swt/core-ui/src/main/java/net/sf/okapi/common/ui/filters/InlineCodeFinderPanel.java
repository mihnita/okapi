...
public class InlineCodeFinderPanel extends Composite {
	...
	private void createContent () {
		...
		edExpression.addModifyListener(e -> updateTest());
		...
		btInsertPattern.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				Util.openURL("https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html"); //$NON-NLS-1$
			};
		});
		...
		edSample.addModifyListener(e -> updateTest());
