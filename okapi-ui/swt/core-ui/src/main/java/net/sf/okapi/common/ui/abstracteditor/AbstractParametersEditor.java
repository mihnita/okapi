...
public abstract class AbstractParametersEditor implements IParametersEditor, Listener, INotifiable {
	...
	protected <T extends Composite> Composite addPage(String caption, Class<T> pageClass) {
		...
		try {
			Constructor<T> cc = pageClass.getConstructor(new Class[] {
		...
		} catch (InstantiationException | InvocationTargetException | IllegalArgumentException | NoSuchMethodException | SecurityException | IllegalAccessException e) {
