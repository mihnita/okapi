...
//	}
	...
	public void setText (TextFragment oriFrag) {
		...
		if ( oriFrag == null ) {
			...
			codes = new ArrayList<>(textFrag.getCodes());
			updateText(null);
		}
	}
	...
	public FragmentData getAllContent () {
		...
		data.codes = new ArrayList<>(codes);
		return data;
	}
		...
		int positionAfter)
	{
		try {
			...
			int pos = sel.x;
			StyleRange sr;
			ArrayList<StyleRange> newRanges = new ArrayList<>();
			int insPos = index;
