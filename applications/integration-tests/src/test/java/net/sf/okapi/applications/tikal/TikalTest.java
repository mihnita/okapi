...
public class TikalTest {
	...
	public void setUp () throws URISyntaxException {
		...
		javaTikal = new String[] { "java", "-cp", libDir + "/*", "net.sf.okapi.applications.tikal.Main" };
	}
...
//    	assertTrue("File different from gold", compareWithGoldFile("yamltest.out.yml", "UTF-8"));
    ...
    public void zz1TestQuerySeveralConnectors () throws IOException, InterruptedException {
    	...
    	int res = runTikal("-q \"Close the <b>application</b>.\" -sl EN-US -tl FR-FR -pen pensieveTM -mm");
    	if ( res != 0 ) {
    		logger.error("\n=============== WARNING ===============");
    ...
    @Test @Ignore
    // Expired certificate, see https://github.com/translate/amagama/issues/3214
    ...
    private int runTikal (String extraArgs) throws IOException, InterruptedException {
    	...
    	logger.info("");
    	logger.info("cmd>===============================================================================");
    	logger.info("cmd>{}", extraArgs==null ? "" : " "+extraArgs);
    	Process p = Runtime.getRuntime().exec(args.toArray(new String[0]), null, root.in("/").asFile());
