...
public class XINIFilterMetainformationTest {
	...
	@Test
	public void sourceAndTargetLanguagesPreserved() {
	...
	@Test
	public void emptyPageDoesntCauseNullPointerException() {
		String snippet =
	...
	@Test
	public void emptyFieldDoesntCauseNullPointerException() {
		String snippet =
			helper.getStartSnippetXiniMain() +
		"		<Page PageID=\"1\">" +
		"			<Elements>" +
	...
	@Test
	public void pageAndElementIsPreserved() {
		String snippet =
			helper.getStartSnippetXiniMain() +
		"		<Page PageID=\"1\">" +
		"			<PageName>Page Title</PageName>" +
	...
	@Test
	public void iniTableIsPreserved() {
		String snippet = helper.getStartSnippet() +
							"	<INI_Table>" +
							"		<TR>" +
							"			<TD Label=\"Test-Label\" CustomerTextID=\"CTiD-123\">" +
	...
	@Test
	public void segmentIsPreserved() {
		String snippet = helper.getStartSnippet() +
							"	<Table>" +
							"		<TR>" +
							"			<TD>" +
