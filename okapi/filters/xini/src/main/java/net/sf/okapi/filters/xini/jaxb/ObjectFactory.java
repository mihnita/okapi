...
public class ObjectFactory {
    ...
    public JAXBElement<Xini> createXini(Xini value) {
        return new JAXBElement<>(_Xini_QNAME, Xini.class, null, value);
    }
    ...
    public JAXBElement<StartPlaceHolder> createTextContentSph(StartPlaceHolder value) {
        return new JAXBElement<>(_TextContentSph_QNAME, StartPlaceHolder.class, TextContent.class, value);
    }
    ...
    public JAXBElement<TextContent> createTextContentSub(TextContent value) {
        return new JAXBElement<>(_TextContentSub_QNAME, TextContent.class, TextContent.class, value);
    }
    ...
    public JAXBElement<TextContent> createTextContentU(TextContent value) {
        return new JAXBElement<>(_TextContentU_QNAME, TextContent.class, TextContent.class, value);
    }
    ...
    public JAXBElement<TextContent> createTextContentB(TextContent value) {
        return new JAXBElement<>(_TextContentB_QNAME, TextContent.class, TextContent.class, value);
    }
    ...
    public JAXBElement<EndPlaceHolder> createTextContentEph(EndPlaceHolder value) {
        return new JAXBElement<>(_TextContentEph_QNAME, EndPlaceHolder.class, TextContent.class, value);
    }
    ...
    public JAXBElement<PlaceHolder> createTextContentPh(PlaceHolder value) {
        return new JAXBElement<>(_TextContentPh_QNAME, PlaceHolder.class, TextContent.class, value);
    }
    ...
    public JAXBElement<TextContent> createTextContentSup(TextContent value) {
        return new JAXBElement<>(_TextContentSup_QNAME, TextContent.class, TextContent.class, value);
    }
    ...
    public JAXBElement<Empty> createTextContentBr(Empty value) {
        return new JAXBElement<>(_TextContentBr_QNAME, Empty.class, TextContent.class, value);
    }
    ...
    public JAXBElement<TextContent> createTextContentI(TextContent value) {
        return new JAXBElement<>(_TextContentI_QNAME, TextContent.class, TextContent.class, value);
    }
