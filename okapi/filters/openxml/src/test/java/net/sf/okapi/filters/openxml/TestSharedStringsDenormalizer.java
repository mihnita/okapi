...
public class TestSharedStringsDenormalizer {
	...
	public void testDenormalize() throws Exception {
		...
		XMLEventReader reader = inputFactory.createXMLEventReader(
				new InputStreamReader(root.in("/xlsx_parts/sharedStrings.xml").asInputStream(),
		...
		FileLocation.In location = FileLocation.fromClass(getClass()).in("/xlsx_parts/gold/Denormalized_sharedStrings.xml");
