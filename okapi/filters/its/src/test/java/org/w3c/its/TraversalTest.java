...
public class TraversalTest {
	...
	public void testWithinText () throws SAXException, IOException, ParserConfigurationException {
		...
		assertNotNull(elem);
		assertFalse(trav.getTranslate(null));
		assertEquals(ITraversal.WITHINTEXT_YES, trav.getWithinText());
	}
	...
	public void testWithinTextLocalSpan () throws SAXException, IOException, ParserConfigurationException {
		...
		ITraversal trav = applyITSRules(doc, null, false, null);
		getElement(trav, "p", 1);
		assertEquals(ITraversal.WITHINTEXT_NO, trav.getWithinText());
	...
	@Test
	public void testMtConfidenceLocalHtml () throws SAXException, IOException {
	...
	@Test
	public void testMtConfidenceGlobalHtml () throws SAXException, IOException {
	...
	@Test
	public void testTextAnalysisPointerHtml () throws SAXException, IOException {
		InputSource is = new InputSource(new StringReader("<!DOCTYPE html><html lang=en><head><meta charset=utf-8>"
			+ "<title>Title</title>"
			+ "<script type='application/its+xml'>"
			+ "<its:rules xmlns:its='http://www.w3.org/2005/11/its' version='2.0'>"
	...
	@Test
	public void testTextAnalysisSimpleHtml () throws SAXException, IOException {
	...
	@Test
	public void testLocQualityRatingHtml () throws SAXException, IOException {
		InputSource is = new InputSource(new StringReader("<!DOCTYPE html><html lang=en><head><meta charset=utf-8>"
		...
		assertNull(trav.getLocQualityRatingVote(null));
		assertNull(trav.getLocQualityRatingVoteThreshold(null));
		assertNull(trav.getLocQualityRatingProfileRef(null));
		elem = getElement(trav, "span", 2);
		assertNotNull(elem);
		assertNull(trav.getLocQualityRatingScore(null));
		assertNull(trav.getLocQualityRatingScoreThreshold(null));
	...
	public void testTargetPointerGlobal () throws SAXException, IOException, ParserConfigurationException {
		...
		assertNotNull(elem);
		assertTrue(trav.getTranslate(null));
		assertNull(trav.getTargetPointer(null));
	...
	public void testStorageSizeGlobal1 () throws SAXException, IOException, ParserConfigurationException {
		...
		assertNull(trav.getStorageSize(null));
		assertEquals("UTF-8", trav.getStorageEncoding(null));
	...
	public void testLQIssueGlobal2 () throws SAXException, IOException, ParserConfigurationException {
		...
		// Values
		assertNull(trav.getLocQualityIssueType(null, 0));
		assertNull(trav.getLocQualityIssueType(null, 1));
		assertEquals("comment1", trav.getLocQualityIssueComment(null, 0));
		assertEquals("comment2", trav.getLocQualityIssueComment(null, 1));
		assertNull(trav.getLocQualityIssueSeverity(null, 0));
		assertEquals(50.0, trav.getLocQualityIssueSeverity(null, 1), 0);
		assertNull(trav.getLocQualityIssueProfileRef(null, 0));
	...
	public void testLQIssueGlobalAndLocal1 () throws SAXException, IOException, ParserConfigurationException {
		...
		assertNull(trav.getLocQualityIssuesRef(null));
		assertNull(trav.getLocQualityIssueComment(null, 0));
		assertNull(trav.getLocQualityIssueSeverity(null, 0));
	...
	public void testLQIssueOnAttributes () throws SAXException, IOException, ParserConfigurationException {
		...
		assertNull(trav.getLocQualityIssueType(attr, 0));
		assertNull(trav.getLocQualityIssueType(attr, 1));
		assertEquals("comment1", trav.getLocQualityIssueComment(attr, 0));
		assertEquals("comment2", trav.getLocQualityIssueComment(attr, 1));
		assertNull(trav.getLocQualityIssueSeverity(attr, 0));
		assertEquals(50.0, trav.getLocQualityIssueSeverity(attr, 1), 0);
		assertNull(trav.getLocQualityIssueProfileRef(attr, 0));
	...
	public void testProvenanceLocal () throws SAXException, IOException, ParserConfigurationException {
		...
		ITraversal trav = applyITSRules(doc, null, false, null);
		Element elem = getElement(trav, "p", 1);
		assertNull(trav.getProvRecordsRef(null));
	...
	@Test
	public void testlangVsXmlLangInXHtml () throws SAXException, IOException {
	...
	@Test
	public void testLocalLanguageInfo () throws SAXException, IOException {
		InputSource is = new InputSource(new StringReader("<!DOCTYPE html><html lang=en><head>"
			+ "<meta charset=utf-8><title>Title</title></head>"
	...
	@Test
	public void testGlobalAndLocalLanguageInfo () throws SAXException, IOException {
		InputSource is = new InputSource(new StringReader("<!DOCTYPE html><html lang=en><head>"
