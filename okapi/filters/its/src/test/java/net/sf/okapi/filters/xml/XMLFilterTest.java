...
public class XMLFilterTest {
	...
	@Test
	public void testCRLFInAttributes () {
		String snippet = "<?xml version=\"1.0\"?>\n"
			+ "<doc>"
			+ "<p attr=\"Line 1 &#xD;&#xA;Line 2\">text</p>"
			+ "</doc>";
		String paramData = "<?xml version=\"1.0\"?>\n"
			...
			+ "<its:translateRule selector=\"*//@attr\" translate=\"yes\" itsx:whiteSpaces=\"preserve\"/>"
			+ "<okp:options escapeLinebreak=\"yes\"/>"
			+ "</its:rules>";
		filter.getParameters().fromString(paramData);
...
//TODO		assertEquals(expect, FilterTestDriver.generateOutput(list, filter.getEncoderManager(), LocaleId.FRENCH));
	...
	public void testLocQualityRatingLocal () {
		...
		assertNull(ga.getString(GenericAnnotationType.LQR_PROFILEREF)); // No value because complete override
	}
