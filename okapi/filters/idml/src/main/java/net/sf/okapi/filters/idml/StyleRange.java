...
class StyleRange {
    ...
    boolean isSubsetOf(StyleRange other) {
        if (getAttributes().isEmpty() && !other.getAttributes().isEmpty()
                || getProperties().properties().isEmpty() && !other.getProperties().properties().isEmpty()) {
            return false;
        }
        ...
        outerProperties:	for (Property property : getProperties().properties()) {
            for (Property otherProperty : other.getProperties().properties()) {
