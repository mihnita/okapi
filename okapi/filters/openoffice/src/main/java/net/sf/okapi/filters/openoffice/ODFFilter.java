...
//	private final Logger logger = LoggerFactory.getLogger(getClass());
	...
	public ODFFilter () {
		...
		attrbutesToExtract = new Hashtable<>();
...
//logger.debug("next will pop annotation: {}",name);
	...
	private static class DefaultEncoderParameters implements IParameters {
