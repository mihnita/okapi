...
public class RegexPlainTextFilterTest {
	...
	public void testParameters() {
		...
		assertEquals(net.sf.okapi.filters.plaintext.regex.Parameters.DEF_RULE, params.rule);
		assertEquals(net.sf.okapi.filters.plaintext.regex.Parameters.DEF_GROUP, params.sourceGroup);
		assertEquals(net.sf.okapi.filters.plaintext.regex.Parameters.DEF_OPTIONS, params.regexOptions);
		...
		assertEquals(1, params.sourceGroup);
		assertEquals(8, params.regexOptions);
		
		// Save filter parameters to a file, load and check if params have changed
		FileLocation.Out paramsOut = location.out("/test_params2.txt");
		...
		assertEquals("(Test (rule))", params.rule);
		assertEquals(2, params.sourceGroup);
		assertEquals(0x88, params.regexOptions);
		...
		assertEquals("(a*+)", params.rule);
		assertEquals(1, params.sourceGroup);
		assertEquals(40, params.regexOptions);
	}
	
	@Test
	public void testNameAndMimeType() {
		assertEquals("text/plain", filter.getMimeType());
		assertEquals("okf_plaintext_regex", filter.getName());
