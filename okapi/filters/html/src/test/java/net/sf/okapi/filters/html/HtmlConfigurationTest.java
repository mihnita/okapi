...
public class HtmlConfigurationTest {
	...
	public void defaultConfiguration() {
		...
		assertEquals(TaggedFilterConfiguration.RULE_TYPE.ATTRIBUTES_ONLY, rules.getElementRuleTypeCandidate("base"));
	}

	@Test
	public void baseTag() {
		final URL url = HtmlFilter.class.getResource("nonwellformedConfiguration.yml");
		final TaggedFilterConfiguration rules = new TaggedFilterConfiguration(url);
		final Map<String, String> attributes = new HashMap<>();
		attributes.put("href", "https://www.example.com/news/index.html");
		assertTrue(rules.isWritableLocalizableAttribute("base", "href", attributes));
	}
	...
	public void preserveWhiteSpace() {
		...
		assertEquals(TaggedFilterConfiguration.RULE_TYPE.EXCLUDED_ELEMENT,
				rules.getElementRuleTypeCandidate("style"));
		assertTrue(rules.isRuleType("pre", TaggedFilterConfiguration.RULE_TYPE.PRESERVE_WHITESPACE));
	...
	public void genericCodeTypes() {
		...
		assertEquals("bold", getElementType(rules, "b"));
		assertEquals("italic", getElementType(rules, "i"));
		assertEquals("underlined", getElementType(rules, "u"));
		assertEquals("image", getElementType(rules, "img"));
		assertEquals("link", getElementType(rules, "a"));
		assertEquals("x", getElementType(rules, "x"));
	}
	...
	public void textUnitCodeTypes() {
		...
		TaggedFilterConfiguration rules = new TaggedFilterConfiguration(url);
		assertEquals("paragraph", getElementType(rules, "p"));
	}
