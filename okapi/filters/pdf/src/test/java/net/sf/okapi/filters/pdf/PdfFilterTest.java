...
public class PdfFilterTest {
	...
	public void testStartDocument() throws URISyntaxException {
		URL url = root.in("/OmegaT_documentation_en.PDF").asUrl();
	...
	public void firstTextUnit() throws URISyntaxException {
		URL url = root.in("/PALC_2011_LT.pdf").asUrl();
		...
		url = root.in("/OmegaT_documentation_en.PDF").asUrl();
		...
		url = root.in("/TAUS-QualityDashboard-September.pdf").asUrl();
