...
public class FileAlignerTest {
	...
	public void setUp() throws Exception {
		...
		oldSrcFiles = new LinkedList<>();
		oldTrgFiles = new LinkedList<>();

		newFiles.add(new FileLikeThing<>(Util.toURI("C:/yyy/one"), "C:/yyy/one"));
		newFiles.add(new FileLikeThing<>(Util.toURI("C:/yyy/two"), "C:/yyy/two"));
		newFiles.add(new FileLikeThing<>(Util.toURI("C:/yyy/yyy/three"), "C:/yyy/yyy/three"));

		oldSrcFiles.add(new FileLikeThing<>(Util.toURI("C:/zzz/one"), "C:/zzz/one"));
		oldSrcFiles.add(new FileLikeThing<>(Util.toURI("C:/zzz/yyy/three"), "C:/zzz/yyy/three"));
		
		oldTrgFiles.add(new FileLikeThing<>(Util.toURI("C:/xxx/one"), "C:/xxx/one"));
		oldTrgFiles.add(new FileLikeThing<>(Util.toURI("C:/xxx/yyy/three"), "C:/xxx/yyy/three"));
	}

	@Test
	public void alignTwoWayFiles() {
		FileAligner<String> aligner = new FileAligner<>(newFiles, oldSrcFiles, newFilesRoot,
				oldSrcFilesRoot);
		aligner.align();
	...
	public void alignThreeWayFiles() {
		FileAligner<String> aligner = new FileAligner<>(newFiles, oldSrcFiles, oldTrgFiles, newFilesRoot,
