...
public class LengthCheckerStepTest {
	...
	public void setUp() throws Exception {
		...
		lengthCheckerStep.handleStartBatch(Event.createStartBatchEvent());
	...
	public void testMaxLength () {
		lengthCheckerStep.getParameters().setMaxCharLengthBreak(9);
		lengthCheckerStep.getParameters().setMaxCharLengthAbove(149);
		lengthCheckerStep.getParameters().setMaxCharLengthBelow(200);
	...
	public void testMinLength () {
		lengthCheckerStep.getParameters().setMinCharLengthBreak(9);
		lengthCheckerStep.getParameters().setMinCharLengthAbove(100);
		lengthCheckerStep.getParameters().setMinCharLengthBelow(50);
