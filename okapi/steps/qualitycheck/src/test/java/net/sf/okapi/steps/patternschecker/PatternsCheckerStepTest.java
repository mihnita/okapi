...
public class PatternsCheckerStepTest {
	...
	public void setUp() throws Exception {
		...
		patternsCheckerStep.handleStartBatch(Event.createStartBatchEvent());
	...
	public void testMISSING_PATTERN () {
		...
		patternsCheckerStep.getParameters().setPatterns(list);
		patternsCheckerStep.handleStartBatch(Event.createStartBatchEvent()); // Make sure we re-initialize
