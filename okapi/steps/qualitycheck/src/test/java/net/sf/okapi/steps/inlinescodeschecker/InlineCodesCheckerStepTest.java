...
public class InlineCodesCheckerStepTest {
	...
	public void setUp() throws Exception {
		...
		inlineCodesCheckStep.handleStartBatch(Event.createStartBatchEvent());
	...
	public void testCODE_OCSEQUENCE () {
		...
		tu.setTarget(LocaleId.FRENCH, new TextContainer("trg "));
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.CLOSING, "b", "</b>", 1);
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append("text");
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.OPENING, "b", "<b>", 1);
	...
	public void testCODE_OCSequenceNoError () {
		...
		tu.setTarget(LocaleId.FRENCH, new TextContainer("trg "));
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.OPENING, "b", "<b>", 2);
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.PLACEHOLDER, "br", "<br/>", 3);
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append("text");
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.CLOSING, "b", "</b>", 2);
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.OPENING, "i", "<i>", 1);
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.CLOSING, "i", "</i>", 1);
	...
	public void testCODE_DIFFERENCE_OrderDiffIsOK () {
		...
		tu.setTarget(LocaleId.FRENCH, new TextContainer("trg "));
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.PLACEHOLDER, "codeType", "<code2/>", 2);
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(" et ");
		tu.getTarget(LocaleId.FRENCH).getSegments().get(0).text.append(TagType.PLACEHOLDER, "codeType", "<code1/>", 1);
