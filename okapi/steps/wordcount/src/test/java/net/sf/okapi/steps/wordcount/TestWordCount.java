...
public class TestWordCount {
	...
	public void testStatics() {
		...
		assertEquals(9, WordCounter.count("The quick (\u201Cbrown\u201D) fox can\u2019t jump 32.3 feet, right?",
				locEN));
	...
	public void testCountApostrophe () {
		...
		assertEquals(11, WordCounter.count("Elle a \u00E9t\u00E9 la " + "premi\u00E8re Fran\u00E7aise d'une famille " +
				"d'\u00E9migr\u00E9s.", locFR));
		assertEquals(11, WordCounter.count("Elle a \u00E9t\u00E9 la " + "premi\u00E8re Fran\u00E7aise d\u2019une " +
				"famille d\u2019\u00E9migr\u00E9s.", locFR));
