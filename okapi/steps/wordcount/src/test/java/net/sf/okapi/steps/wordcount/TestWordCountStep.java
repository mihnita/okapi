...
public class TestWordCountStep {
	...
	public void testTextUnitCounts() {
		testTextUnitCounts(LocaleId.ENGLISH, new String[]{"The number of words in this segment is 9.", "The number of " +
				"words in this second segment is 10.", "And the number of words in this third segment is 11."},
				new long[]{9, 10, 11, 30});
	}
