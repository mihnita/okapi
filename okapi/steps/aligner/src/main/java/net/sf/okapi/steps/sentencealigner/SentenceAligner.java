...
public class SentenceAligner {
	...
	private ITextUnit alignWithoutSkeletonAlignment(ITextUnit sourceParagraph,
		...
		AlignmentFunction<Segment> alignmentFunction = new AlignmentFunction<>(srcLocale,
	...
	private ITextUnit alignSegments(ITextUnit sourceParagraph, ITextUnit targetParagraph,
		...
		DpMatrix<Segment> matrix = new DpMatrix<>(sourceParagraph.getSource().getSegments().asList(),
		...
		List<AlignedPair> alignedPairs = new LinkedList<>();
	...
	private ITextUnit alignSegments(ITextUnit bilingualParagraph, LocaleId srcLocale,
		...
		DpMatrix<Segment> matrix = new DpMatrix<>(bilingualParagraph.getSource().getSegments().asList(),
