...
import net.sf.okapi.steps.common.AbstractCompoundStep;
...
public class ScopingReportStep extends AbstractCompoundStep {
	...
	protected Event handleEndBatchItem(Event event) {
		IWithAnnotations res = event.getResource();
		if (res != null) {
	...
	public String getName() {
		return "Scoping Report";
	}

	@Override
	public String getDescription() {
		return "Create a template-based scoping report based on word count and leverage annotations."
