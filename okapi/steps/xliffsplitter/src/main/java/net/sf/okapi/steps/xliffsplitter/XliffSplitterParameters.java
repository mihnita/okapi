...
public class XliffSplitterParameters extends StringParameters implements IEditorDescriptionProvider {
	...
	private static final String RESTOREORIGINALNAMES = "restoreOriginalNames";
	...
	public void setRestoreOriginalNames (boolean restoreOriginalNames) {
		setBoolean(RESTOREORIGINALNAMES, restoreOriginalNames);
	}

	public boolean getRestoreOriginalNames () {
		return getBoolean(RESTOREORIGINALNAMES);
	}
	...
	public ParametersDescription getParametersDescription() {
		...
		desc.add(RESTOREORIGINALNAMES, "Restore original file names", null);
	...
	public EditorDescription createEditorDescription (ParametersDescription paramsDesc) {
		...
		cbp = desc.addCheckboxPart(paramsDesc.get(RESTOREORIGINALNAMES));
