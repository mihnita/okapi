...
public class TextFragmentTest {
	...
	@Test
	public void referenceMarkerCreated() {
		assertEquals(
			"[#$\\\\\\\\\\\\ \\] \\\\ \\\\\\\\\\\\\\\\ \\]]",
			TextFragment.makeRefMarker("\\\\\\ ] \\ \\\\\\\\ ]")
		);
		assertEquals(
			"[#$\\\\\\\\\\\\ \\] \\\\ \\\\\\\\\\\\\\\\ \\]@%prop \\] \\\\]",
			TextFragment.makeRefMarker("\\\\\\ ] \\ \\\\\\\\ ]", "prop ] \\")
		);
	}

	@Test
	public void referenceMarkerObtained() {
		Object[] actual = TextFragment.getRefMarker(
			new StringBuilder("[#$\\\\\\\\\\\\ \\] \\\\ \\\\\\\\\\\\\\\\ \\]]")
		);
		assertNotNull(actual);
		assertEquals("\\\\\\ ] \\ \\\\\\\\ ]", actual[0]);
		actual = TextFragment.getRefMarker(
			new StringBuilder("[#$\\\\\\\\\\\\ \\] \\\\ \\\\\\\\\\\\\\\\ \\]@%prop \\] \\\\]")
		);
		assertNotNull(actual);
		assertEquals("\\\\\\ ] \\ \\\\\\\\ ]", actual[0]);
		assertEquals("prop ] \\", actual[3]);
	}
...
//TOFIX		assertEquals(2, codes.get(1).id); // placeholder
	...
	@Test
	public void testGetTextWithOkapiMarkers () {
		TextFragment frag = new TextFragment("watch out for ");
		frag.append(TagType.OPENING, "b", "<b>");
		frag.append("the \ue101\ue102 killer");
		frag.append(TagType.CLOSING, "b", "</b>");
	...
	public void testCharSequence () {
		...
		assertTrue(pat.matcher(tf).find());
		assertNotNull(new StringBuilder(tf));
	}
	...
	public void testToStringWithCodes () {
		TextFragment tf = makeFragment1();
		// [b]A[br/]B[/b]C == xxAxxAxxC
		assertNotEquals(tf.toText(), tf.toString()); // Codes so they are not the same
    ...
    public void testCompareToDifferentFragment () {
		TextFragment tf1 = new TextFragment("text of the fragment");
		TextFragment tf2 = new TextFragment("text Of The Fragment");
		assertNotEquals(0, tf1.compareTo(tf2));
		assertNotEquals(0, tf1.compareTo(tf2, true));
    }
    ...
    public void testBalanceMarkersWithIsolatedCodes() {
        ...
        Code code = new Code(TagType.CLOSING, "tag"); // No matching opening code
        code.setId(1);
        tf.append(code);
        ...
        code = new Code(TagType.OPENING, "tag"); // No matching closing code
        code.setId(3);
        tf.append(code);
    ...
    public void testBalanceMarkersWithIsolatedCodesUnassignedId() {
        ...
        code = new Code(TagType.CLOSING, "tag"); // The default id
        code.setId(-1);
        tf.append(code);
    ...
    @Ignore //TODO: Remove me when issue #791 is fixed.
    @Test
    public void testBalanceMarkersOverlapingPairs() { // Issue #792
        TextFragment tf = new TextFragment();
    ...
    @Test
    public void testBalanceMarkerIdempotent() { // Issue #792
        // "<t>abc<u>xxx</t>def</u>"
        ...
        tf.balanceMarkers(); // First call. Note the following tf.getCodes() would make this call if this line weren't here.
	...
	@Test
	public void testAppendMaskingMarkersRegularText() {
		TextFragment tf = new TextFragment();
		tf.append("abc",null);
		assertEquals("abc", tf.getCodedText());
	}

	@Test
	public void testAppendMaskingMarkersMarkerStart() {
		TextFragment tf = new TextFragment();
		tf.append("\uE101abc",null);
		assertEquals("\uE103\uE110abc", tf.getCodedText());
	}
	...
	@Test
	public void testAppendMaskingMarkersMarkerMiddle() {
		TextFragment tf = new TextFragment();
		tf.append("ab\uE101cd",null);
		assertEquals("ab\uE103\uE110cd", tf.getCodedText());
	}

	@Test
	public void testAppendMaskingMarkersMarkerEnd() {
		TextFragment tf = new TextFragment();
		tf.append("abc\uE101",null);
		assertEquals("abc\uE103\uE110", tf.getCodedText());
	}
	...
	@Test
	public void testAppendMaskingMarkersChr() {
		TextFragment tf = new TextFragment();
		tf.append('\uE101');
		assertEquals("\uE103\uE110", tf.getCodedText());
	}
	@Test
	public void testAppendMaskingMarkersMarkerCSQStart() {
		TextFragment tf = new TextFragment();
		tf.append((CharSequence) "\uE101abc",null);
		assertEquals("\uE103\uE110abc", tf.getCodedText());
	}

	@Test
	public void testAppendMaskingMarkersMarkerCSQMiddle() {
		TextFragment tf = new TextFragment();
		tf.append((CharSequence) "ab\uE101cd",null);
		assertEquals("ab\uE103\uE110cd", tf.getCodedText());
	}

	@Test
	public void testAppendMaskingMarkersMarkerCSQEnd() {
		TextFragment tf = new TextFragment();
		tf.append((CharSequence) "abc\uE101",null);
		assertEquals("abc\uE103\uE110", tf.getCodedText());
	}
	...
	@Test
	public void testAppendMaskingMarkersWithMarkers() {
		TextFragment tf = new TextFragment();
		tf.append("abc\uE100\uE101\uE102\uE103\uE104");
		assertEquals("abc\uE100\uE103\uE110\uE103\uE111\uE103\uE112\uE104", tf.getCodedText());
		assertEquals(3, tf.getCodes().size());
		Code c1 = tf.getCode(0);
		Code c2 = tf.getCode(1);
		Code c3 = tf.getCode(2);

		assertTrue(c1.isMarkerMasking());
		assertEquals("\uE101", c1.getData());
		assertEquals(1, c1.getId());
		assertTrue(c2.isMarkerMasking());
		assertEquals("\uE102", c2.getData());
		assertEquals(2, c2.getId());
		assertTrue(c3.isMarkerMasking());
		assertEquals("\uE103", c3.getData());
		assertEquals(3, c3.getId());
	}

	@Test
	public void testAppendMaskingMarkersWithMarkersAndTransformFunction() {
		TextFragment tf = new TextFragment();
		int idBase[] = {10};
		tf.append("abc\uE100\uE101\uE102\uE103\uE104", (c) -> { c.setId(idBase[0]++); return c; });
		assertEquals("abc\uE100\uE103\uE110\uE103\uE111\uE103\uE112\uE104", tf.getCodedText());
		assertEquals(3, tf.getCodes().size());
		Code c1 = tf.getCode(0);
		Code c2 = tf.getCode(1);
