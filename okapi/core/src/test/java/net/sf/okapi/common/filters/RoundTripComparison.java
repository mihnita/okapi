...
public class RoundTripComparison {
	...
	public RoundTripComparison (boolean includeSkeleton) {
		extraction1Events = new ArrayList<>();
		extraction2Events = new ArrayList<>();
		subDocEvents = new ArrayList<>();
...
//			}
	...
	private void executeSecondExtraction() {
		try {
			...
			String input = new String(writerBuffer.toByteArray(), StandardCharsets.UTF_16);
