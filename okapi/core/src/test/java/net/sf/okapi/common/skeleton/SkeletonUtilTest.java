...
public class SkeletonUtilTest {
	...
	public void testGenericSkeletonWriter() {
		...
		writer.processStartDocument(ENUS, UTF_8, null, new EncoderManager(), sd);
		assertEquals("source", writer.processTextUnit(tu1));
		
		writer.processStartDocument(FRFR, UTF_8, null, new EncoderManager(), sd);
		assertEquals("source", writer.processTextUnit(tu1));
		
		writer.processStartDocument(ESES, UTF_8, null, new EncoderManager(), sd);
