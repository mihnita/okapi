/*===========================================================================
  Copyright (C) 2008-2019 by the Okapi Framework contributors
-----------------------------------------------------------------------------
...
public class ParametersTest {
	...
	public void testLoadParametersFromWindowsFile () {
		StringParameters params = new StringParameters();
		URL url = FileLocation.fromClass(ParametersTest.class).in("/ParamTest01_lf.txt").asUrl();
	...
	static class TestParameters extends StringParameters {
