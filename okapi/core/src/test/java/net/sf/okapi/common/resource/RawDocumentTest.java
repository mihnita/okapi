...
public class RawDocumentTest {
	...
	@Test
	public void getReaderWithURI() throws IOException {
		URI uri = FileLocation.fromClass(RawDocumentTest.class).in("/test_lf.html").asUri();
	...
	@Test
	public void testFromStream () throws FileNotFoundException
	{
	...
	@Test
	public void testOutputIsDifferentFromInput () throws FileNotFoundException
	{
		File expectedFile = FileLocation.fromClass(this.getClass()).out("/safeouttest1.out.txt").asFile();
		expectedFile.delete();
	...
	@Test
	public void testOutputIsSameAsInput () throws FileNotFoundException
	{
		File expectedFile = FileLocation.fromClass(this.getClass()).out("/safeouttest1.out.txt").asFile();
		expectedFile.delete();
	...
	public void testTargetLocaleWithSetters () {
		...
		ArrayList<LocaleId> list = new ArrayList<>();
