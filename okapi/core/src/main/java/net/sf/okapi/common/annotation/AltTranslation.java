...
public class AltTranslation implements Comparable<AltTranslation> {
	 ...
	 * This is used to qualify further the type of the alternate translation. for example in XTM XLIFF file it specifies additional flags like "leveraged-inherited".
	 * @return the exType attribute of this alt-translation (can be null).
	 */
	...
	public int compareTo (AltTranslation other) {
		...
		// compare score
		comparison = Integer.compare(this.combinedScore, other.getCombinedScore());
		if ( comparison != EQUAL ) {
