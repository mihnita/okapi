...
public class LanguageToolTest {
    ...
    public LanguageToolTest() {
        ...
        ltConn.initialize(locFR, locEN, serverUrl, false);

        ltConnBilingual = Mockito.spy(new LanguageToolConnector());
        ltConnBilingual.initialize(locFR, locEN, serverUrl, true);
    }
    ...
    public void testLanguageTool() throws Exception {
        ...
        //mock of response
        Mockito.doReturn(new JSONParser().parse(response)).when(ltConn).sendRequest(Mockito.any(URL.class));
    ...
    public void testLanguageToolBilingual() throws Exception {
        ...
        Mockito.doReturn(new JSONParser().parse(response)).when(ltConnBilingual).sendRequest(Mockito.any(URL.class));
