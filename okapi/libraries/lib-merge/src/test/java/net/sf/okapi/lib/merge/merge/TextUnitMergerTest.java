...
public class TextUnitMergerTest {
	...
	public void mergeWithoutCodes() {
		...
		tuFromTrans.createTarget(LocaleId.FRENCH, false, IResource.COPY_ALL);
	...
	public void testXLIFF () {
		...
		try (final XLIFFFilter xliffFilter = new XLIFFFilter()) {
			...
			// since id matches copied from source
			assertEquals("<ph id=\"1\" ts=\"z\">C1</ph>", code.getOuterData());
