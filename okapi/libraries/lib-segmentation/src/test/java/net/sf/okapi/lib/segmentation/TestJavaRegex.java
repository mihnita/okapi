...
//				"Mr.", " Holmes is from the U.K. not the U.S.", 5);
	...
	// The syntax tested here and expected to fail is supported starting with JDK 9
	private void testPatternSyntaxException(String text, String bbr, String abr, String beforeBreak,
			String afterBreak) {
		// Examples: 1.7.0_75  1.8.0_151  1.8.0_152-release  1.8.0_191  9  10.0.2  11.0.1  12-ea
