...
public class ReportGeneratorTest {
	...
	public void reportTest() {
		ReportGenerator gen = new ReportGenerator(root.in("test_report.txt").asInputStream());
	...
	public void tableReportTest() {
		ReportGenerator gen = new ReportGenerator(root.in("test_table_report.txt").asInputStream());
	...
	public void tableReportTest2() {
		ReportGenerator gen = new ReportGenerator(root.in("test_table_report2.txt").asInputStream());
...
//		gen.setField("A10", "<a10.5>");
	...
	public void tableReportTest5() {
		ReportGenerator gen = new ReportGenerator(root.in("scoping_report.html").asInputStream());
	...
	public void tableReportTest6() {
		ReportGenerator gen = new ReportGenerator(root.in("scoping_report2.html").asInputStream());
		assertTrue(gen.isHtmlReport());
	...
	public void tableReportTest7() {
		ReportGenerator gen = new ReportGenerator(root.in("test_table_report3.txt").asInputStream());
	...
	public void tableReportTest8() {
		ReportGenerator gen = new ReportGenerator(root.in("test_table_report4.txt").asInputStream());
		assertFalse(gen.isHtmlReport());
		assertFalse(gen.isMultiItemReport());
	}
	...
	public void tableReportTest9() {
		ReportGenerator gen = new ReportGenerator(root.in("test_template1.txt").asInputStream());
		assertFalse(gen.isHtmlReport());
		assertTrue(gen.isMultiItemReport());
	...
	public void tableReportTest10() {
		ReportGenerator gen = new ReportGenerator(root.in("test_template2.txt").asInputStream());
		assertFalse(gen.isHtmlReport());
		assertTrue(gen.isMultiItemReport());
	...
	public void tableReportTest11() {
		ReportGenerator gen = new ReportGenerator(root.in("test_template3.txt").asInputStream());
		assertFalse(gen.isHtmlReport());
		assertTrue(gen.isMultiItemReport());
	...
	public void tableReportTest12() {
		ReportGenerator gen = new ReportGenerator(root.in("test_template4.txt").asInputStream());
		assertFalse(gen.isHtmlReport());
		assertTrue(gen.isMultiItemReport());
