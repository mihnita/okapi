...
public class ReportGenerator implements IReportGenerator {
	...
	private boolean isCompoundField(String fieldName) {
		return isSimpleField(fieldName) && (fieldName.contains("[") && fieldName.contains("]"));
	}
	...
	private void registerField(String fieldName, boolean isMultiple) {
		if (isMultiple)
			multiFields.put(fieldName, new LinkedList<>());
		else
	...
	public void setTemplate(String template) {
		...
		htmlReport = template.contains("<html") && template.contains("<body");
